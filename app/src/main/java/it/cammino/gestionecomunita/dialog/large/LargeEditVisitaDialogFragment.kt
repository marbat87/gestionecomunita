...
@Suppress("unused")
class LargeEditVisitaDialogFragment : EditVisitaDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        dialog.setTitle(getString(if (mBuilder.mEditMode) R.string.modifica_visita else R.string.nuova_visita))
        ...
        mView.findViewById<TextInputLayout>(R.id.data_visita_text_field).editText?.doOnTextChanged { _, _, _, _ ->
    ...
    companion object {
        ...
        private fun newInstance() = LargeEditVisitaDialogFragment()

        private fun newInstance(builder: Builder): LargeEditVisitaDialogFragment {
