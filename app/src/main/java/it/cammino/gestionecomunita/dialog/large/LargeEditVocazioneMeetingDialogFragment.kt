...
@Suppress("unused")
class LargeEditVocazioneMeetingDialogFragment : EditVocazioneMeetingDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        mView.findViewById<TextInputLayout>(R.id.tipo_autcomplete).editText?.doOnTextChanged { _, _, _, _ ->
    ...
    companion object {
        ...
        private fun newInstance() = LargeEditVocazioneMeetingDialogFragment()

        private fun newInstance(builder: Builder): LargeEditVocazioneMeetingDialogFragment {
