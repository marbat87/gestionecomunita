...
@Suppress("unused")
class LargeViewSeminaristaDialogFragment : ViewSeminaristaDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val mBuilder = builder
            ?: throw IllegalStateException("LargeViewSeminaristaDialogFragment should be created using its Builder interface.")
    ...
    companion object {
        ...
        private fun newInstance() = LargeViewSeminaristaDialogFragment()
